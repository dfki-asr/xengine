...
void ILP_Solver_CBC::_num_hazards(const size_t t, const size_t d,
                                  const size_t i, const size_t k,
                                  const string c_ub, const string c_lb) {
...
void ILP_Solver_CBC::add_constraint(const string mode, const float rhs) {
...
void ILP_Solver_CBC::add_marker(const string mode, const string name,
...
void ILP_Solver_CBC::add_row(const string name) {
...
void ILP_Solver_CBC::add_column(const string name) {
  auto m = _marker[name];
  string content = "";
  for (auto p : m.values) {
    string type = p.first;
...
int ILP_Solver_CBC::defineProblem() {
